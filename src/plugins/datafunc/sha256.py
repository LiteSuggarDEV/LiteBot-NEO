...
@on_command("sha256", aliases={"sha256加密", "SHA256"},state=MatcherData(rm_desc="SHA256加密",rm_name="SHA256加密",rm_usage="/SHA256 <text>").model_dump()).handle()
async def sha256_runner(
